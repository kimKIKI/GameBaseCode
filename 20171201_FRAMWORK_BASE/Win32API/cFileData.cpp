...
void cFileData::txtSave(char* saveFileName, vector<string> vecData)
{
	HANDLE file;
	char szBuf[128];
	DWORD write;
...
char* cFileData::vectorArrayCombine(vector<string> vArray)
{
	char szBuf[128];
...
vector<string> cFileData::txtLoad(char * loadFileName)
{
	HANDLE file;
	char szBuf[128];
	DWORD read;
...
vector<string> cFileData::charArraySeparation(char charArray[])
{
